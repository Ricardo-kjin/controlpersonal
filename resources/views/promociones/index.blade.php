                      ...
                      <tbody>
                          @foreach ($promociones as $promocion)
                              <tr>
                                  ...
                                  <td class="align-middle text-sm">
                                    <p class="text-xs font-weight-bold mb-0 ">{{ $promocion->monto }}</p>
                                    {{-- <p class="text-xs text-secondary mb-0">Organization</p> --}}
                                </td>
                                  <td class="align-middle text-sm">
                                  ...
                                  <td class="align-middle">
                                    ...
                                    <form action="{{ URL('/promociones/'.$promocion->id) }}" method="POST" id="eliminarRegistroForm" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
